...
class FP_Shortcode {
	...
	public function shortcode_form() {
		...
		wp_enqueue_script( 'fp-script' );
		//wp_enqueue_script( 'fp-script-ajax' );
		wp_enqueue_script( 'fp-script-rest' );
		wp_enqueue_script( 'jquery-form' );
		wp_enqueue_style( 'fp-styles' );
		wp_enqueue_script( 'fp-select2-script' );
		wp_enqueue_style( 'fp-select2-style' );
